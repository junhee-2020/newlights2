    ...
    if(pageName === 'AboutChurchView') {
        return new Promise((resolve) => {
            resolve([            
                ...
                {   key: '3',
                    title: '젊은 예배',
                    contents: ['일시 : 주일 낮 1시', '장소 : 새빛교회 본당']
                },
                {   key: '4',
                    title: '중고청 젊은 예배',
                    contents: ['일시 : 주일 낮 3시', '장소 : 새빛교회 본당']
                },
            ]);
        });
        ...
        return new Promise((resolve) => {
            resolve([            
                {   key: '1',
                    title: '터다지기반',
                    contents: ['대상: 믿기 시작한 청/장년', '일시 : 화요일 오후 5시','장소 : 새빛교회 교육관']
                },
                {   key: '2',
                    title: '장로 기도회',
                    contents: ['대상: 장로', '일시 : 주일 오후 1시', '장소 : 새빛교회 교육관']
                },
                {   key: '3',
                    title: '여구역장 성경공부',
                    contents: ['대상: 여구역장', '일시 : 목요일 오후 6시', '장소 : 새빛교회 교육관']
                },
                {   key: '4',
                    title: '제자 훈련',
                    contents: ['대상: 리더 추천자', '일시 : 금요일 오후 7시 30분', '장소 : 새빛교회 교육관']
                },
                {   key: '5',
                    title: '청년 헬퍼 훈련',
                    contents: ['대상: 청년 헬퍼 및 청년 리더 추천자', '일시 : 목요일 오후 7시 30분', '장소 : 새빛교회 교육관']
                },
                {   key: '6',
                    title: '청년 리더 및 헬퍼 훈련',
                    contents: ['대상: 청년 리더 및 헬퍼', '일시 : 토요일 오후 5시', '장소 : 새빛교회']
                },
            ]);
        });
